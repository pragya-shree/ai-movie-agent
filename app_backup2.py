...
st.set_page_config(
    page_title="🎬 MovieMind AI | Your Personal AI Movie Companion",
    layout="wide",
    page_icon="🎬",
)
...
st.markdown(
    ...
    <div class="hero">
        ...
        <p class="hero-subtitle">Your Personal AI Movie Companion</p>
...
st.markdown(
    ...
    <div class="app-footer">
        Built with ❤️ using Gemini AI, Streamlit &amp; Machine Learning
    </div>
    """,
    unsafe_allow_html=True,
)
